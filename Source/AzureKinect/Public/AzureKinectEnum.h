...
{
	RESOLUTION_OFF = 0		UMETA(DisplayName = "Color Camera Turned Off"),        /**< Depth sensor will be turned off with this setting. */
	RESOLUTION_720P			UMETA(DisplayName = "1280 * 720  [16:9]"), /**< Depth captured at 320x288. Passive IR is also captured at 320x288. */
	RESOLUTION_1440P		UMETA(DisplayName = "2560 * 1440 [16:9]"),  /**< Depth captured at 640x576. Passive IR is also captured at 640x576. */
	RESOLUTION_1536P		UMETA(DisplayName = "2048 * 1536 [4:3]"), /**< Depth captured at 512x512. Passive IR is also captured at 512x512. */
	RESOLUTION_2160P		UMETA(DisplayName = "3840 * 2160 [16:9]"),  /**< Depth captured at 1024x1024. Passive IR is also captured at 1024x1024. */
	RESOLUTION_3072P		UMETA(DisplayName = "4096 * 3072 [4:3]"),     /**< Passive IR only, captured at 1024x1024. */
};
